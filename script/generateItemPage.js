...
const generateItemPage = () => {
    ...
    const renderCard = ({ category, count, description, name: itemName, price, subcategory, id, img }) => {
        ...
        const goodPriceValue = document.querySelector('.good-item__price-value');
        ...
        goodPriceValue.textContent = price;
